...
class Coma(torch.nn.Module):
    ...
    def __init__(self, 
          ...
          n_nodes,
          mode="testing"
          z_aggr_function=lambda x: torch.Tensor.mean(x, axis=0)
        ):
        ...
        self.cheb_enc = self._build_encoder()
        self.cheb_dec = self._build_decoder()                
        self.pool = Pool()
...
class Coma4D(Coma):
    ...
    def __init__(self, *args):
        super(ComaContentStyle).__init__(*args)
